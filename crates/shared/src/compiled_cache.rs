...
// Only unreferenced native code is disposable under this budget. Published
// versions, rollback targets and in-flight work are retained separately.
pub const UNPROTECTED_BUDGET_BYTES: u64 = 2 * 1024 * 1024 * 1024;
pub const UNPROTECTED_MAX_ENTRIES: usize = 256;

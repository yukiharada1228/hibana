...
公開npm版`0.2.0-rc.12`で、Hibanaのリポジトリ・Docker・kubectlを持たない開発者のPCから、ログイン・作成・deploy・tail・rollbackを確認します。ここにあるURLは設定例です。実環境の接続先とテナント名へ置き換えてください。
...
npx --yes @yukiharada1228/hibana@0.2.0-rc.12 init remote-pilot
cd remote-pilot
```

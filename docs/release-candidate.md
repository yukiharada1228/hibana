...
| 配布物 | ファイル |
| --- | --- |
| CLI | `hibana-cli-0.2.0-rc.9.tgz` |
| Kubernetesマニフェスト | `hibana-kubernetes-0.2.0-rc.9.tar.gz` |
| PC用ランタイム | `hibana-worker-0.2.0-rc.9-{darwin,linux}-{x64,arm64}`の4ファイル |
...
npx --yes --package=./hibana-cli-0.2.0-rc.9.tgz hibana --version
npx --yes --package=./hibana-cli-0.2.0-rc.9.tgz hibana runtime install --from ./hibana-worker-0.2.0-rc.9-darwin-arm64 --sha256 HASH
npx --yes --package=./hibana-cli-0.2.0-rc.9.tgz hibana init hello --cli-package ./hibana-cli-0.2.0-rc.9.tgz
cd hello
npm run dev
...
docker tag hibana-platform:0.2.0-rc.9-linux-amd64 registry.example.internal/hibana/platform:0.2.0-rc.9-amd64
docker push registry.example.internal/hibana/platform:0.2.0-rc.9-amd64
